...
class MenuitemsControllerTest < ActionController::TestCase
  ...
  test "should create menuitem" do
    assert_difference('Menuitem.count') do
      post :create, menuitem: { menu_name: @menuitem.menu_name, user_id: @menuitem.user_id }
    end
  ...
  test "should update menuitem" do
    patch :update, id: @menuitem, menuitem: { menu_name: @menuitem.menu_name, user_id: @menuitem.user_id }
    assert_redirected_to menuitem_path(assigns(:menuitem))
  end
